...
## Find installer files for your system here: [QEMU-QuickBoot-v1.5 Release-Page](https://github.com/GlitchLinux/QEMU-QuickBoot/releases/tag/QEMU-QuickBoot-v1.5)
